                ...
                'child_routes' => [
                    ...
                    'Company' => [
                        ...
                        'options' => [
                            'route' => '/company',
                            'defaults' => [
                                'controller' => \PI\Controller\CompanyController::CLASS,
                                'action' => 'grid',
                            ],
                        ],
                        'child_routes' => [
                    ...
                    'UserCompany' => [
                        ...
                        'options' => [
                            'route' => '/user-company',
                            'defaults' => [
                                'controller' => \PI\Controller\UserCompanyController::CLASS,
                                'action' => 'grid',
                            ],
                        ],
                        'child_routes' => [
                    ...
                    'JobType' => [
                        ...
                        'options' => [
                            'route' => '/job-type',
                            'defaults' => [
                                'controller' => \PI\Controller\JobTypeController::CLASS,
                                'action' => 'grid',
                            ],
                        ],
                        'child_routes' => [
                    ...
                    'JobSearch' => [
                        ...
                        'options' => [
                            'route' => '/job-search',
                            'defaults' => [
                                'controller' => \PI\Controller\JobSearchController::CLASS,
                                'action' => 'grid',
                            ],
                        ],
                        'child_routes' => [
